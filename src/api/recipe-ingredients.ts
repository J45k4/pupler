...
export const recipeIngredientsCollectionRoute = async (req: Request) => {
	if (req.method === "GET") {
	...
	if (req.method === "POST") {
		...
		return json(201, await fetchRecipeIngredientDetail(db, created.id))
	}
	throw new HttpError(405, "Method not allowed for this route")
}

export const recipeIngredientDetailRoute = async (req: BunRequest<string>) => {
