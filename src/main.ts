...
export const server = (options: ServerOptions = {}) => {
	...
	return Bun.serve({
		...
		routes: {
			...
			"/api/purchase-receipts": purchaseReceiptsCollectionRoute(db),
			"/api/purchase-receipts/:id": purchaseReceiptDetailRoute(db),
			"/api/purchase-receipt-items":
				purchaseReceiptItemsCollectionRoute(db),
			"/api/purchase-receipt-items/:id":
				purchaseReceiptItemDetailRoute(db),
