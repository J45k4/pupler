...
const navigationEntries: NavigationEntry[] = [
	...
	{
		href: "/inventory/expirations",
		label: "Expirations",
		group: "Inventory",
		keywords: "expires food",
	},
	{
		href: "/inventory",
		label: "Inventory",
		group: "Inventory",
		keywords: "stock storage containers",
	},
	{
		href: "/spending/items",
		label: "Receipt Items",
		group: "Spending",
		keywords: "recent purchases search product store category",
	},
	{
		href: "/spending/monthly",
		label: "Monthly Spending",
		group: "Spending",
		keywords: "month chart",
	},
	{
		href: "/time/monthly",
		label: "Monthly Time",
		group: "Time",
		keywords: "month time report",
	},
	{
		href: "/recipes/new",
		label: "New Recipe",
	...
	},
	{
		...
		label: "Products",
		group: "Catalog",
		keywords: "barcode product lookup",
	},
	{
		href: "/products/stats",
		label: "Product Stats",
		group: "Catalog",
		keywords: "bought used usage table",
	},
	{
		href: "/projects",
		label: "Projects",
		group: "Time",
		keywords: "work project clockify",
	},
	{
		href: "/receipts",
		label: "Receipts",
		group: "Spending",
		keywords: "purchases receipt",
	},
	...
	},
	{
		...
		label: "Users",
		group: "Settings",
		keywords: "accounts administrators permissions",
	},
	{
		href: "/shoppinglist",
		label: "Shopping List",
	...
	},
	{
		...
		group: "Spending",
		keywords: "categories costs",
	},
	{
		href: "/spending/overview",
		label: "Spending Overview",
		group: "Spending",
		keywords: "money report",
	},
	{
		href: "/time/overview",
		label: "Time Overview",
		group: "Time",
		keywords: "time report",
	},
	{
		href: "/time",
		label: "Timer",
		group: "Time",
		keywords: "time tracking start timer",
	},
...
export const renderNavbar = (
	...
	const activeEntry = activeNavigationEntry(
		currentPath,
	...
	brand.dataset.link = ""
	brand.append(
		createElement("span", { className: "brand__badge", text: "Pupler" }),
	)
...
export const attachNavigationMenu = (
	...
	const filterResults = (query: string) => {
		...
		for (const link of resultLinks) {
			const matches =
				!normalized || (link.dataset.label ?? "").includes(normalized)
			link.hidden = !matches
