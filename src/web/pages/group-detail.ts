...
const renderGroupDetail = (group: Group, receipts: PurchaseReceipt[]) => {
	...
	const metadata = createElement(
		...
		createElement(
			...
			createElement("dd", { id: "group-detail-created" }),
		),
		createElement(
			"div",
			{},
			createElement("dt", {}, "Updated"),
			createElement("dd", { id: "group-detail-updated" }),
		),
	)
	page.replaceChildren(
		createElement(
			...
			createElement(
				"div",
				{},
				createElement("span", { className: "eyebrow" }, "Group"),
			),
			back,
		),
		createElement(
			...
			createElement(
				...
				createElement("h2", {}, "Group Details"),
				form,
				createElement("div", {
			...
			createElement(
				...
				createElement(
					...
					createElement("span", {
						id: "group-detail-receipt-count",
						className: "tag tag--neutral",
					}),
				),
				createElement("div", {
					id: "group-detail-receipts",
					className: "results",
				}),
			),
		),
		...
		results.replaceChildren(
			...(receipts.length
				? receipts.map((receipt) =>
						createReceiptCard(receipt, { draggable: false }),
					)
