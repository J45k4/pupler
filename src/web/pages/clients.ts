...
const projectSummary = (client: Client, projects: Project[]) => {
	...
	const activeCount = linkedProjects.filter(
...
export const renderClientsPage = () => {
	...
	const page = createElement(
		"section",
		{ className: "workspace clients-workspace" },
		createElement(
			"div",
