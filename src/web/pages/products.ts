...
export const renderProductsPage = () => {
	...
	const searchType = createElement(
		"select",
		{
			id: "product-search-type",
			className: "toolbar__select",
			attributes: { "aria-label": "Product search type" },
		},
		...[
			["auto", "Auto"],
			["barcode", "Barcode"],
			...
			createElement("option", { properties: { value } }, label),
		),
	)
	const stats = createElement(
		"a",
		{
			...
			properties: { href: "/products/stats" },
	...
	const perishable = createElement(
		"select",
		{ id: "is_perishable", properties: { name: "is_perishable" } },
		createElement("option", { properties: { value: "true" } }, "true"),
		createElement("option", { properties: { value: "false" } }, "false"),
	)
	const productForm = createElement(
		"form",
		{ id: "product-form" },
		createElement(
			"label",
		...
		createElement(
			...
			createElement("input", {
				id: "barcode",
				properties: { name: "barcode", placeholder: "6414893400012" },
			}),
		),
		createElement(
			"label",
			...
			createElement("input", {
				id: "ingredient_name",
				properties: { name: "ingredient_name", placeholder: "Sausage" },
			}),
		),
		createUploadDropzone({
			inputId: "picture",
	...
	page.append(
		createElement(
			...
			createElement(
				...
				createElement("div", { id: "status", className: "status" }),
				createElement("div", { id: "results", className: "results" }),
			),
		),
		createModal({
